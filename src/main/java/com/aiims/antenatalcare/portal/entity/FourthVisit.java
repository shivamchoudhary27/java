...
@Entity
@Table(name = "fourth_visit")
public class FourthVisit {
	@Id
	@GeneratedValue
	private Integer id;
	...
	public FourthVisit(Integer id, Date lmp, Integer pog, Integer breath, Integer fatiguability, Integer headache,
			...
			String vvOedemaValue, String advMedicine, String othersText, String womanBloodGroup, String wBGroup,
