...
@Entity
@Table(name = "third_visit")
public class ThirdVisit {
	...
	@Column(name = "leaking_pv")
	private Integer leakingPv;
	...
	public void setCbcValue(Integer cbcValue) {
	...
	public void setLeakingPv(Integer leakingPv) {
		this.leakingPv = leakingPv;
	}
	...
	public ThirdVisit(Integer id, Date lmp, Integer pog, Integer breath, Integer fatiguability, Integer headache,
			...
			String gttGlucose, Integer gttFasting, Integer gtt1hr, Integer gtt2hr, String cbc, Integer cbcValue,
			...
			String vvOedemaValue, String advMedicine, String caOthers, String othersText, String womanBloodGroup,
			...
			String urinermRefer, String urinecs, String urinecsRefer, Integer leakingPv, Date nextVisit, Date today,
