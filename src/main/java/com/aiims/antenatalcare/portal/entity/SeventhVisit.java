...
@Entity
@Table(name = "seventh_visit")
public class SeventhVisit {
	...
	@Column(name = "pallor", length = 255)
	private String pallor;

	@Column(name = "pedal_edema", length = 255)
	...
	public SeventhVisit(Integer id, Date lmp, Integer pog, Integer breath, Integer fatiguability, Integer headache,
			...
			String pelvi, String genAdvice, String general, String nutrition, Integer nVomiting, String nVomitingValue,
