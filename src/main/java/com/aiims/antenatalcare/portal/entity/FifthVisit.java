...
@Entity
@Table(name = "fifth_visit")
public class FifthVisit {
	...
	public FifthVisit(Integer id, Date lmp, Integer pog, Integer breath, Integer fatiguability, Integer headache,
			Integer bleeding, Integer micturition, Integer fetalMove, Integer itching, Integer othersCheck,
			String otherDetails, String modeOfDelivery, String timing, String birth, String laborAnalysis,
			String pallor, String pelvic, String pedalEdema, Integer weight, Integer height, Integer bmi,
			Integer pulseRate, Integer systolic, Integer diastolic, Integer mean, Integer pa, String othersD,
			String genAdvice, String general, String nutrition, String cbc, Integer usg, Integer nVomiting,
			String nVomitingValue, Integer heartBurn, String heartBurnValue, Integer legCramps, String legCrampsValue,
			Integer lowBackPain, String lowBackPainValue, Integer constipation, String constipationValue,
			Integer vvOedema, String vvOedemaValue, String advMedicine, String caOthers, String womanBloodGroup,
			String wBGroup, String aboRh, String husBloodGroup, String husBGroup, String ict, String ictValue,
			String hemogram, Integer hb, String hbValue, String tsh, Integer tshValue, String tshRefer, String hiv,
			String hivRefer, String hbsag, String hbsagRefer, String vdrl, String vdrlRefer, String urinerm,
			String urinermRefer, String urinecs, String urinecsRefer, Date nextVisit, Date today, Date createdAt,
			Date updatedAt) {
		super();
		this.id = id;
		this.lmp = lmp;
