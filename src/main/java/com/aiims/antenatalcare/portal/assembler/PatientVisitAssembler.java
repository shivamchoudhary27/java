...
@Component
public class PatientVisitAssembler implements BaseAssembler<PatientVisit, PatientVisitDto> {

    @Override
    public PatientVisitDto toDto(PatientVisit patientVisit) {
    ...
    public PatientVisit toEntity(PatientVisitDto dto) {
        PatientVisit entity = new PatientVisit();
