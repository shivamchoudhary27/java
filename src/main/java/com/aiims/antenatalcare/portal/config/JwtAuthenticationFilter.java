...
import com.aiims.antenatalcare.portal.service.JwtService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if (null == authHeader || authHeader.isBlank() || authHeader.isEmpty()
        ...
        if (null != userEmail && !userEmail.isBlank() && !userEmail.isEmpty()
